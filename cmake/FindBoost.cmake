...
function(_Boost_GUESS_COMPILER_PREFIX _ret)
    ...
    elseif (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
        string(REPLACE "." "" _clang_VER_STR "${CMAKE_CXX_COMPILER_VERSION}")
        string(SUBSTRING "${_clang_VER_STR}" 0 2 _boost_COMPILER_VERSION)
...
foreach(COMPONENT ${Boost_FIND_COMPONENTS})
    ...
    foreach(compiler IN LISTS _boost_COMPILER)
        list(APPEND _boost_RELEASE_NAMES
                ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_RELEASE_ABI_TAG}${_boost_BITSIZE}-${Boost_LIB_VERSION}
                ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_RELEASE_ABI_TAG}${_boost_BITSIZE})
    endforeach()
    list(APPEND _boost_RELEASE_NAMES
            ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_RELEASE_ABI_TAG}${_boost_BITSIZE}-${Boost_LIB_VERSION}
            ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_RELEASE_ABI_TAG}${_boost_BITSIZE}
            ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT} )
    if(_boost_STATIC_RUNTIME_WORKAROUND)
        set(_boost_RELEASE_STATIC_ABI_TAG "-s${_boost_RELEASE_ABI_TAG}")
        foreach(compiler IN LISTS _boost_COMPILER)
            list(APPEND _boost_RELEASE_NAMES
                    ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_RELEASE_STATIC_ABI_TAG}${_boost_BITSIZE}-${Boost_LIB_VERSION}
                    ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_RELEASE_STATIC_ABI_TAG}${_boost_BITSIZE} )
        endforeach()
        list(APPEND _boost_RELEASE_NAMES
                ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_RELEASE_STATIC_ABI_TAG}${_boost_BITSIZE}-${Boost_LIB_VERSION}
                ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_RELEASE_STATIC_ABI_TAG}${_boost_BITSIZE} )
    endif()
    ...
    foreach(compiler IN LISTS _boost_COMPILER)
        list(APPEND _boost_DEBUG_NAMES
                ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_DEBUG_ABI_TAG}${_boost_BITSIZE}-${Boost_LIB_VERSION}
                ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_DEBUG_ABI_TAG}${_boost_BITSIZE} )
    endforeach()
    list(APPEND _boost_DEBUG_NAMES
            ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_DEBUG_ABI_TAG}${_boost_BITSIZE}-${Boost_LIB_VERSION}
            ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_DEBUG_ABI_TAG}${_boost_BITSIZE}
    ...
    if(_boost_STATIC_RUNTIME_WORKAROUND)
        ...
        foreach(compiler IN LISTS _boost_COMPILER)
            list(APPEND _boost_DEBUG_NAMES
                    ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_DEBUG_STATIC_ABI_TAG}${_boost_BITSIZE}-${Boost_LIB_VERSION}
                    ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${compiler}${_boost_MULTITHREADED}${_boost_DEBUG_STATIC_ABI_TAG}${_boost_BITSIZE} )
        endforeach()
        list(APPEND _boost_DEBUG_NAMES
                ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_DEBUG_STATIC_ABI_TAG}${_boost_BITSIZE}-${Boost_LIB_VERSION}
                ${Boost_LIB_PREFIX}${Boost_NAMESPACE}_${COMPONENT}${_boost_MULTITHREADED}${_boost_DEBUG_STATIC_ABI_TAG}${_boost_BITSIZE} )
    endif()
    if(Boost_THREADAPI AND ${COMPONENT} STREQUAL "thread")
